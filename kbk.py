...
async def _(event):
    if ispay[0] == "yes":
        ...
        await eighthon.send_message('@kbkbot', '/start')
        await asyncio.sleep(10)
        msg0 = await eighthon.get_messages('@kbkbot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(10)
        msg1 = await eighthon.get_messages('@kbkbot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await eighthon.get_messages('@kbkbot', limit=1)
